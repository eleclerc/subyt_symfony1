CREATE TABLE dancer (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(255), website VARCHAR(255));
CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT, name VARCHAR(100), state VARCHAR(100));
CREATE TABLE song (id INTEGER PRIMARY KEY AUTOINCREMENT, title VARCHAR(100), artist VARCHAR(100));
CREATE TABLE video (id INTEGER PRIMARY KEY AUTOINCREMENT, url VARCHAR(255), youtube_id VARCHAR(40) NOT NULL UNIQUE, youtube_title VARCHAR(100), youtube_description VARCHAR(1000), youtube_thumbnail VARCHAR(255), published INTEGER DEFAULT '0' NOT NULL, year INTEGER, event_id INTEGER, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL);
